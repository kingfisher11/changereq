...
<head>
    ...
    <title>{{ $title ?? config('app.name') }} : e-Maklumbalas</title>
...
<body class="hold-transition layout-footer-fixed sidebar-mini text-sm">
<div class="wrapper">
    <!-- Sidebar -->
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="modal-logout" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Select "Sign Out" below if you are ready to end your current session.</p>
                </div>
