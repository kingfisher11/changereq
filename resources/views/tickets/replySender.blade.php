@extends('layouts.apps', ['activePage' => 'reply', 'titlePage' => __('Balas')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" action="{{ route('ticket.store.reply')}}" method="POST" enctype="multipart/form-data">
                        ...
                        $responder = $loginuser;
                        @endphp
                        <input type="hidden" id="responder" name="responder" value="{{ $responder->id ?? ''}}">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Kepada :</label>
                                <div class="col-sm-4">
                                <input type="text" id="response" name="response" value="{{ $tickets->name ?? ''}}" class="form-control @error('response') is-invalid @enderror" readonly>
                                </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Isu :</label>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Maklum Balas ID :</label>
                                <div class="col-sm-4">
                                    <input type="text" name="ticketId" value="{{ $tickets->id ?? ''}}" class="form-control @error('ticketId') is-invalid @enderror" readonly>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Set Status<span style="color: red;">*</span> :</label>
                                <div class="col-sm-4">
